...
try
   {
      ...
      $wrk=new \proc\worker\WorkerAnalysis(
         new \proc\messaging\tasks\EndpointWorkerAnalysis(
            \messaging\Manager::getInstance()->getChannel(),
            \proc\messaging\tasks\EndpointWorkerAnalysis::MODE_TRANSIENT
         ),
         $logger
      );
